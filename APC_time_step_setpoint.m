function [ P_a_tot, P_a_tot_pv, P_a_wind, P_sp_string, case_2] = APC_time_step_setpoint(P_a_string, P_a_pv, P_sp_pcc,P_pcc,P_current_string,j, time_done, P_sp_string, a_p, Ntb, Npv,P_a_tot, P_a_tot_pv, P_a_wind, case_2)
