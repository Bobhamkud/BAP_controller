...
for j = 1:length(t)-1
    ...
    [Q_sp_strings, Q_available_wind, Q_available_solar, Q_total_available, error, u, Q_big, Opti_new, Opti_switch, count] = RPC_time_setpoint( j, Ntb, Npv, Opti_new, Opti_switch, threshold_opt, Optimization_setpoint, Q_available_m, Q_sp_strings, Q_sp_pcc, Q_pcc, error, u, Q_big, count, distribution, z, optQs, Q_options, k_p, bs,t, T_i,Q_available_wind, Q_available_solar, Q_total_available);
    ...
    if j > 2 && ( (rem(j,270)==0) || j==length(t)-1 )
