function [P_sp_string, time_done, rise_end] = APC_rise_time_v2( P_sp_string,P_sp_pcc,j, Ntb, Npv, N_rise, rise, rise_end, time_done, P_a_string)
...
%         end
    ...
    z = any(P_sp_string(j,:) > P_a_string(j,:));
