...
sp_2 = 400;                              % second set point 400 MW
t_sp2 = 40;                              % second set point at 40 seconds
sp_3 = 500;                              % third set point 200 MW
t_sp3 = 110;                             % third set point at 110 seconds
sp_4 = 300;                              % fourth set point 100 MW
...
for j = 2:length(t)-1
    ...
    if P_sp_pcc(j) < P_tot_cap && P_sp_pcc(j)<P_sp_pcc(j-1)
        case_1 = 0;
        case_2 = 0;
        case_3 = 1;
    elseif P_sp_pcc(j) < P_tot_cap
        case_1 = 0;
        case_2 = 1;
        case_3 = 0;
    else
    ...
    elseif case_2 == 1
        ...
        P_sp_string(j,:) = P_current_string(1,:) + beta*Delta_pcc;
